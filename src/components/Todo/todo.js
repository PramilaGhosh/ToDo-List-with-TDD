            ...
            <>
                <Container style={{ margin: "20px auto" }}>
                    <Col md={{ span: 4, offset: 4 }}>
                        ...
                        <InputGroup input-testid="getByTestId" className="mb-3">
                            ...
                            <Button button-testid="add-button" variant="outline-info" size='sm' onClick={() => this.addOrUpdateToDo(inputFromUser)} >{isEditing ? <AiOutlineCheckCircle /> : <IoIosAddCircle />}</Button>
                            ...
                            {listGroupItems.map((listGroupItems, index) => (
                                <ListGroup.Item variant="success" key={index}>
                                    <Row>
                                        ...
                                        <Col md={3} >{" "}
                                            <Button button-testid="edit-button" variant="warning" style={{ padding: "3px" }} onClick={() => this.ToDoItemEdit(index)}><AiTwotoneEdit /></Button>
                                            <Button button-testid="delete-button" variant="danger" style={{ padding: "3px", margin: "3px" }} onClick={() => this.ToDoDelete(index)}><MdDelete /></Button>
                                        </Col>
                                    </Row>
                                </ListGroup.Item>
                            ))}
